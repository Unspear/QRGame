"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([["page_js-pack_ts"],{
...
/* harmony import */ var _pwa__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./pwa */ "./pwa.ts");
...
/* harmony import */ var _tab__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./tab */ "./tab.ts");
...
/* harmony export */ });
/* harmony import */ var _compiled_ppmd_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./compiled/ppmd.js */ "./compiled/ppmd.js");

var MyPPMd = await (0,_compiled_ppmd_js__WEBPACK_IMPORTED_MODULE_0__["default"])({});
...
/* harmony export */   PALETTE_FRACTIONS: () => (/* binding */ PALETTE_FRACTIONS)
/* harmony export */ });
...
/* harmony export */   Unpacker: () => (/* binding */ Unpacker),
/* harmony export */   dataToUrl: () => (/* binding */ dataToUrl),
/* harmony export */   gameToUrl: () => (/* binding */ gameToUrl),
/* harmony export */   packGame: () => (/* binding */ packGame),
/* harmony export */   unpackGame: () => (/* binding */ unpackGame),
...
/* harmony import */ var _compressor__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./compressor */ "./compressor.ts");
/* harmony import */ var _tile__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./tile */ "./tile.ts");
...
class Packer {
    ...
    packUint8Array(value) {
        value = _compressor__WEBPACK_IMPORTED_MODULE_1__.compress(value);
...
class Unpacker {
    ...
    unpackUint8Array() {
        ...
        return _compressor__WEBPACK_IMPORTED_MODULE_1__.decompress(value);
    }
}
// Import/Export
...
function urlToGame() {
    ...
    if (urlData === null) {
        return new _game__WEBPACK_IMPORTED_MODULE_0__.Game();
    }
    return unpackGame(urlData);
}
function gameToUrl(game, page = "play") {
...
class TileMap {
    ...
    draw(renderer, isEditor = false) {
        for (let i = 0; i < this.count; i++) {
            this.drawSingle(renderer, i, { x: i * this.dim.w * _constants__WEBPACK_IMPORTED_MODULE_0__.CHAR_WIDTH, y: 0 });
        }
        if (isEditor) {
            renderer.drawGrid(0, 0, this.dim.w * _constants__WEBPACK_IMPORTED_MODULE_0__.CHAR_WIDTH * this.count, this.dim.h * _constants__WEBPACK_IMPORTED_MODULE_0__.CHAR_WIDTH, this.dim.w * this.count, this.dim.h);
            for (let i = 0; i < this.count; i++) {
                let offset = i * this.dim.w * _constants__WEBPACK_IMPORTED_MODULE_0__.CHAR_WIDTH;
                renderer.drawBox(offset, 0, offset + this.dim.w * _constants__WEBPACK_IMPORTED_MODULE_0__.CHAR_WIDTH, this.dim.h * _constants__WEBPACK_IMPORTED_MODULE_0__.CHAR_WIDTH, -1.5);
            }
        }
    }
    drawSingle(renderer, index, point) {
...
class PatchMap {
    ...
    draw(renderer, patchSource, isEditor = false) {
        for (let patchX = 0; patchX < this.dim.w; patchX++) {
            for (let patchY = 0; patchY < this.dim.h; patchY++) {
                ...
                patchSource.drawSingle(renderer, patchId, { x: patchX * patchSource.dim.w * _constants__WEBPACK_IMPORTED_MODULE_0__.CHAR_WIDTH, y: patchY * patchSource.dim.h * _constants__WEBPACK_IMPORTED_MODULE_0__.CHAR_WIDTH });
            }
        }
        if (isEditor) {
            renderer.drawGrid(0, 0, patchSource.dim.w * this.dim.w * _constants__WEBPACK_IMPORTED_MODULE_0__.CHAR_WIDTH, patchSource.dim.h * this.dim.h * _constants__WEBPACK_IMPORTED_MODULE_0__.CHAR_WIDTH, this.dim.w, this.dim.h);
            renderer.drawBox(0, 0, patchSource.dim.w * this.dim.w * _constants__WEBPACK_IMPORTED_MODULE_0__.CHAR_WIDTH, patchSource.dim.h * this.dim.h * _constants__WEBPACK_IMPORTED_MODULE_0__.CHAR_WIDTH, -1.5);
        }
...
module.exports = __webpack_require__.p + "5a875fe39a17f0cc9c81.wasm";

/***/ }

}]);
//# sourceMappingURL=page_js-pack_ts.bundle.js.map